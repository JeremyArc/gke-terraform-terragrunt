...
subnetwork                    = dependency.vpc.outputs.private_subnet_name
ip_range_pods                 = dependency.vpc.outputs.private_subnet_ip_range_pod
ip_range_services             = dependency.vpc.outputs.private_subnet_ip_range_services
